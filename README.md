...
Encapsulation: Explored the concept of encapsulation in Java, focusing on bundling data (fields) and methods that operate on the data into a single unit (class). Discussed the use of access modifiers (private, public) and getter/setter methods to control access to private fields.

Polymorphism: Delved into the concept of polymorphism, particularly method overriding and method overloading, allowing objects to be treated as instances of their parent class while enabling dynamic method resolution at runtime.

Interface: Studied the definition and usage of interfaces in Java. Focused on how interfaces allow classes to define a contract for other classes to implement, ensuring consistent behavior across different classes.
